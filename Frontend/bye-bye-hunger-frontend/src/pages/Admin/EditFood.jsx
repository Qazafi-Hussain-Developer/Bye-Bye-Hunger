...
const EditFood = () => {
  ...
  const fetchFood = async () => {
    try {
      ...
      if (food.image) {
        setImagePreview(food.image ? `http://localhost:5000${food.image}` : "");
      }
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${API_URL}/foods/${id}`, data, {
        headers: { 
      ...
      setError(error.response?.data?.message || "Failed to update food item");
    } finally {
      setSubmitting(false);
    }
  };
                ...
                <div className="image-preview">
                  ...
                  <button 
                    ...
                    onClick={() => {
                      ...
                      setImagePreview(formData.existingImage ? `${API_URL}${formData.existingImage}` : "");
                    }}
                  >
